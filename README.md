...
- **categories** (`1`) ───► (`N`) **products**
  - One category (e.g., _Adult Cartoons_) maps to many individual sticker products. Removing a category is restricted if active products rely on its key constraint.
