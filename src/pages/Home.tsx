        ...
        <div className="relative z-10 mx-auto w-full max-w-[1600px] px-4 sm:px-8 h-full">
          ...
          <div className={`flex flex-col items-center text-center ${selectedCategory === 'ALL' ? '' : 'hidden'}`}>
            <div className="max-w-3xl flex flex-col justify-center items-center">
              <h1 className="mt-2 font-black uppercase leading-tight tracking-[0.1em] md:tracking-[0.2em] text-[clamp(1.5rem,6vw,4.5rem)] text-cyan-100 drop-shadow-[0_0_30px_rgba(34,211,238,0.4)] whitespace-nowrap [word-spacing:0.2em] md:[word-spacing:0.4em]">
                Stuck on&nbsp;
